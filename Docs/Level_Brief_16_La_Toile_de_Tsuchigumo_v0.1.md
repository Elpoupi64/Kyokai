...
| **Onibi** | Projectile lent à trajectoire lisible (bestiaire 10.2), rencontré pour la première fois au Niveau 01 — ici la réponse canonique complète (déviation par ombrelle) est pleinement disponible depuis plusieurs actes | Déviation par ombrelle — dernière apparition prévue d'Onibi dans les quatre premiers actes, boucle refermée depuis le tout premier niveau de la campagne. |
...
- Ce niveau referme la boucle d'Onibi ouverte au Niveau 01 (première apparition avec réponse limitée au mouvement de base) — dernière apparition prévue de cette famille dans les quatre premiers actes documentés.
